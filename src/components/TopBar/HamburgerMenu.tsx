    ...
    <>
      ...
      >
        <nav className="absolute right-0 top-14 flex flex-col gap-6 w-screen p-4
          ...
          <Link href="/" onClick={() => setNavigationExpanded(false)}>Home</Link>
          <Link href="/about" onClick={() => setNavigationExpanded(false)}>About Us</Link>
          <Link href="/help" onClick={() => setNavigationExpanded(false)}>Help</Link>
          <Link href="/careers" onClick={() => setNavigationExpanded(false)}>Careers</Link>
        </nav>
      </Transition>
    </>
  );
